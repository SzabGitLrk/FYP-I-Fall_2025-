...
export function BulkStudentForm({ open, onOpenChange, onSuccess }: BulkStudentFormProps) {
  ...
  const downloadTemplate = () => {
    const csvContent = `regId,regName,email,phone,dateOfBirth,address,programCode,semesterNumber,isActive
2024-CS-001,Ahmed Hassan Khan,ahmed.hassan@university.edu.pk,+92 300 1234567,2000-01-15,"House 123, Street 45, Lahore",CS,1,true
2024-CS-002,Fatima Ali Shah,fatima.ali@university.edu.pk,+92 301 2345678,1999-12-20,"Apartment 456, Block B, Karachi",CS,1,true
2024-EE-001,Muhammad Usman,muhammad.usman@university.edu.pk,+92 302 3456789,2001-03-10,"Villa 789, Phase 2, Islamabad",EE,2,true`
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(`Successfully imported ${result.data.successful} students`)
        if (result.data.failed > 0) {
          toast.warning(`${result.data.failed} students failed to import`)
        }
        onSuccess()
      } else {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="space-y-1 text-muted-foreground">
                      <li>• regId (unique registration ID)</li>
                      <li>• regName (full name)</li>
              ...
              <CardContent>
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Student Import Template</p>
                      <p className="text-sm text-muted-foreground">CSV file with sample data</p>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Processing CSV file and creating student records
                    </p>
                  </div>
                </CardContent>
              </Card>
