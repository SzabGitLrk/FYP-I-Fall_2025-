...
export const ResetPasswordPageShell = styled(Box)(({ theme }) => ({
  position: 'relative',
  minHeight: '100dvh',
  overflow: 'hidden',
  display: 'flex',
...
export const ResetPasswordContent = styled(Box)(({ theme }) => ({
  position: 'relative',
  zIndex: 2,
  width: '100%',
  maxWidth: 668,
...
export const ResetPasswordTitle = styled(Typography)(({ theme }) => ({
...
export const ResetPasswordDescription = styled(Typography)(({ theme }) => ({
...
export const SendButton = styled(Box)(({ theme }) => ({
  ...
  '&:hover': {
    ...
    boxShadow: 'inset 0 4px 9px rgba(4, 80, 38, 0.3), 0 4px 12px rgba(21, 113, 69, 0.2)',
  },
  '&:active': {
...
export const BackToLoginLink = styled(Typography)(({ theme }) => ({
  display: 'block',
...
export const ErrorCard = styled(Card)(({ theme }) => ({
  ...
  [theme.breakpoints.down('sm')]: {
    maxWidth: 430,
    padding: theme.spacing(2.4, 1.8),
    borderRadius: 14,
  },
}));

export const ErrorCardContainer = styled(Box)(({ theme }) => ({
  position: 'relative',
  zIndex: 2,
  width: '100%',
  maxWidth: 668,
