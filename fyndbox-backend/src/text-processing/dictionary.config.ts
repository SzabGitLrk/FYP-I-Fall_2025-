...
export const DICTIONARY_CONFIG = {
    ...
    INTENTS: {
        ...
        CREATE: [
            'create', 'setup', 'make', 'new', 'build',
            'establish', 'add new', 'produce', 'generate', 'initiate',
            'register', 'organize', 'prepare', 'construct', 'design',
            'install', 'deploy', 'start', 'open', 'launch', 'found',
            'set up', 'get', 'acquire', 'purchase', 'buy', 'rent'
        ],
        /** Add/increment items or boxes */
       
        INCREMENT: [
            'add', 'put', 'insert', 'append', 'plus', 'enter', 'place',
            'store', 'keep', 'save', 'deposit', 'pack', 'fill',
            'load', 'stock', 'stocking', 'include', 'throw in', 'toss in',
            'drop in', 'slip in', 'push', 'shove', 'slide', 'fit',
            'arrange', 'position', 'lay', 'set', 'place in', 'put in',
            'drop', 'park', 'situate', 'lodging', 'house', 'accommodate'
        ],
        /** Remove/decrement items */
        DECREMENT: [
            'remove', 'throw', 'takeout', 'delete', 'discard', 'minus',
            'take', 'clear', 'empty', 'drop', 'pull', 'extract',
            'withdraw', 'dispose', 'trash', 'bin', 'sell', 'donate',
            'eject', 'expel', 'oust', 'banish', 'exile', 'dismiss',
            'release', 'free', 'liberate', 'unload', 'unpack', 'deduct',
            'subtract', 'cut', 'slash', 'reduce', 'diminish', 'decrease'
        ],
        /** Update/modify existing items */
        UPDATE: [
            'update', 'edit', 'change', 'modify', 'alter', 'revise',
            'rename', 'retitle', 'adjust', 'correct', 'fix', 'amend',
            'refresh', 'upgrade', 'rearrange', 'reorganize', 'move',
            'relocate', 'shift', 'transfer', 'swap', 'exchange', 'substitute',
            'replace', 'renew', 'restructure', 'redesign', 'rebuild'
        ],
    },
    ...
    ENTITIES: {
        ...
        STORAGE: [
            'storage', 'room', 'area', 'space', 'warehouse', 'zone', 'store', 'shop',
            'cabinet', 'cupboard', 'attic', 'basement', 'garage', 'shed',
            'depot', 'repository', 'vault', 'stockroom', 'stockpile', 'hoard',
            'pod', 'unit', 'chamber', 'hall',
            'building', 'facility', 'premises', 'location', 'place', 'spot',
            'house', 'home', 'office',  'godown', 'storehouse',
            'lodge', 'quarters', 'residence', 'dwelling', 'flat', 'apartment',
            'suite', 'floor', 'level', 'section', 'sector', 'division', 'wing',
            'farm', 'barn', 'stable', 'coop', 'pen', 'enclosure', 'yard'
        ],
        /** Box types - containers for items */
        BOX: [
            'boxes', 'box', 'bin', 'crate', 'container', 'carton', 'drawer', 'shelf',
            'case', 'trunk', 'chest', 'tub', 'bucket', 'bag', 'sack', 'pouch',
            'basket', 'hamper', 'tote', 'organizer', 'compartment', 'tray',
            'locker', 'closet', 'wardrobe', 'storage box', 'plastic container',
            'cardboard', 'archive box', 'archive', 'file box', 'banker box',
            'toolbox', 'supply cabinet', 'supply closet', 'rack', 'cubby',
            'cubbyhole', 'safe', 'strongbox', 'cashbox', 'kit',
            'pack', 'bundle', 'wrap', 'envelope', 'packet', 'parcel', 'package',
        ],
        /** Item types - things that go inside boxes */
        ITEM: [
            'items', 'item', 'object', 'thing', 'article', 'stuff', 'goods',
            'products', 'merchandise', 'supplies', 'materials', 'equipment',
            'gear', 'tools', 'utensils', 'possessions', 'belongings', 'assets',
            'inventory', 'stock', 'collection', 'set',
            'components', 'parts', 'pieces', 'elements', 'contents', 'cargo',
            'freight', 'load', 'shipment', 'consignment',
        ],
    },
     ...
     */
    CONNECTORS: [
        'named', 'called', 'label', 'labeled', 'marked', 'titled', 'known as','known',
        'in', 'as', 'for', 'under', 'with name', 'titled as', 'designated',
        'referenced', 'identified as', 'termed', 'dubbed', 'christened',
        'alias', 'renamed', 'labeled as', 'styled', 'tagged', 'badged',
        'branded', 'nicknamed', 'sized', 'dimensioned', 'measured'
    ],
     ...
     */
    CONTAINMENT_KEYS: [
        'containing', 'including', 'like', 'with item', 'with items',
        'has', 'holds', 'containing items', 'filled with', 'packed with',
        'stuffed with', 'loaded with', 'stocked with', 'filled', 'packed',
        'holding', 'including items', 'comprising', 'consisting of', 'containing item',
        'storing', 'keeping', 'housing', 'accommodating',
        'full of', 'full of items', 'full of things', 'full of stuff',
        'stuffed', 'jam packed', 'crowded', 'crammed', 'loaded','having'
    ],
     ...
     */
    DESCRIPTION_KEYS: [
        'details', 'note', 'desc', 'meaning', 'description', 'with',
        'note that', 'description is', 'details are', 'marked as', 'described as',
        'info', 'information', 'remarks', 'comments', 'observations', 'specifications',
        'about', 'regarding', 'concerning', 'pertaining to', 'relating to',
        'consisting', 'featuring', 'located'
    ],
    ...
    STOP_WORDS: [
        ...
        'thank you', 'thanks', 'thankyou', 'many thanks',
        'hi', 'hello', 'hey', 'greetings',
        'good morning', 'good afternoon', 'good evening',
        'sorry', 'dear', 'please', 'very much'
    ],
    ...
    SPELLCHECK_EXCLUDED_WORDS: [
        'garage', 'office', 'home', 'house',
        'archive', 'hamper', 'toolbox', 'cabinet', 'closet', 'drawer',
        'locker', 'wardrobe', 'shelf', 'rack', 'tray', 'basket',
        'tools', 'gear', 'equipment', 'supplies', 'materials', 'inventory',
        'stock', 'collection', 'contents', 'cargo', 'load', 'kit',
        'toy', 'toys',
    ...
    PROTECTED_WORDS: [
        // Articles
        'and', 'the', 'is', 'in', 'to', 'for', 'with', 'on', 'at', 'by',
        'an', 'a', 'it', 'my', 'new', 'map', 'of', 'or', 'but', 'not',
        'big',
        // Common verbs
        'be', 'are', 'was', 'were', 'been', 'being', 'have', 'has', 'had',
        'do', 'does', 'did', 'will', 'would', 'could', 'should', 'may', 'might',
        'must', 'shall', 'can', 'need', 'get', 'got', 'go', 'goes', 'went',
        // Pronouns
        'this', 'that', 'these', 'those',
        'i', 'you', 'he', 'she', 'we', 'they', 'me', 'him', 'her', 'us', 'them',
        // Prepositions
        'from', 'into', 'out', 'up', 'down', 'over', 'under', 'again', 'once',
        'about', 'after', 'before', 'behind', 'below', 'above', 'across',
        'along', 'among', 'around', 'between', 'during', 'through', 'until',
        // Others
